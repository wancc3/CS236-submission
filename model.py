...
class Generator64(nn.Module):
    ...
    def __init__(self, nz=128, ngf=1024, bottom_width=4):
        ...
        self.attn2 = Self_Attn(ngf >> 1)
        self.attn3 = Self_Attn(ngf >> 2)
        self.attn4 = Self_Attn(ngf >> 3)
        self.attn5 = Self_Attn(ngf >> 4)
...
class Discriminator64(nn.Module):
    ...
    def __init__(self, ndf=1024):
        ...
        self.attn2 = Self_Attn(ndf >> 3)
        self.attn3 = Self_Attn(ndf >> 2)
        self.attn4 = Self_Attn(ndf >> 1)
...
class Generator128(nn.Module):
    ...
    def __init__(self, nz=128, ngf=2048, bottom_width=4):
        super().__init__()
        ...
        self.b6 = nn.BatchNorm2d(ngf >> 5)
        self.c6 = nn.Conv2d(ngf >> 5, 3, 3, 1, padding=1)
        self.activation = nn.ReLU(True)
...
class Discriminator128(nn.Module):
    ...
    def __init__(self, ndf=2048):
        super().__init__()

        self.block0 = DBlockOptimized(3, ndf >> 5)
        self.block1 = DBlock(ndf >> 5, ndf >> 4, downsample=True)
        self.block2 = DBlock(ndf >> 4, ndf >> 3, downsample=True)
        self.block3 = DBlock(ndf >> 3, ndf >> 2, downsample=True)
        self.block4 = DBlock(ndf >> 2, ndf >> 1, downsample=True)
        self.block5 = DBlock(ndf >> 1, ndf, downsample=True)
